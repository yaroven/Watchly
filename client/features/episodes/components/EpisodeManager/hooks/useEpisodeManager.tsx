...
import {
  CreateEpisodeFormSchema,
  CreateEpisodeFormValues,
  Episode,
  UpdateEpisodeFormSchema,
} from "@/features/episodes/schemas/episode";
...
export const useEpisodeManager = ({ seasonId, episodes }: UseEpisodeManagerProps) => {
  ...
  const {
    ...
    resolver: zodResolver(
      editingEpisode ? UpdateEpisodeFormSchema : CreateEpisodeFormSchema,
    ) as Resolver<CreateEpisodeFormValues>,
    mode: "onBlur",
  });
  ...
  const { submit, uploadProgress, isUploading, createMutation, updateMutation } =
    useEpisodeSubmissionWorkflow({
      seasonId,
      editingEpisode,
